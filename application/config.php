...
// +----------------------------------------------------------------------
error_reporting(E_ALL & ~E_NOTICE);//关闭为定义变量错误警告 建议在开发中开启养成良好开发习惯
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '@?t+]{%D,ok}*$2Jz[a89pQ/Tw5;<hUg)!#~7sHO', //默认数据加密KEY
	'data_cache_key'=> '@?t+]{%D,ok}*$2Jz[a89pQ/Tw5;<hUg)!#~7sHO',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'@?t+]{%D,ok}*$2Jz[a89pQ/Tw5;<hUg)!#~7sHO', //加密KEY
