...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
			<?php if (IS_ROOT): ?>
				<div class="btn btn-sm btn-success ajax-get iframe" href="<?php echo url('addhook'); ?>"><i class="fa fa-fw fa-plus"></i> 新 增</div>
			<?php endif ?>
		</div>
		<!-- 数据列表 -->
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr>
							...
							<td>
								<a class="ajax-get iframe btn btn-xs btn-success" title="编辑" href="<?php echo url('edithook?id='.$vo['id']); ?>"><i class="fa fa-fw fa-edit"></i></a>
								<a class="confirm ajax-get btn btn-xs btn-danger" title="删除" href="<?php echo url('delhook?id='.$vo['id']); ?>"><i class="fa fa-fw fa-trash"></i></a>
							</td>
						</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
