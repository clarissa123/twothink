...
<div class="row">
    <div class="col-xs-12">
        ...
        <div>
            <button type="button" class="btn btn-info ajax-get iframe" url="<?php echo url('add'); ?>">新增</button>
            <button id="nestable-menu" type="button" data-action="collapse-all" class="btn bg-teal">收起所有</button>
        </div>

        <div class="dd" id="nestable2">
            <ol class="dd-list">
                <?php echo action('channel/tree', array($tree)); ?>
            </ol>
        </div>
    </div>
</div>
