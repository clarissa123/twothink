...
<div class="row">
    <div class="col-xs-12">
        <div class="btn ajax-get iframe btn-info" url="<?php echo url('add'); ?>"><i class="fa fa-fw fa-plus"></i>新增</div>
