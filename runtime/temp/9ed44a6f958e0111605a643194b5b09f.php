...
<div class="row">
    <div class="col-xs-12">
        <div class="cf margin-bottom-5">
            <a id="export" class="btn bg-aqua" href="javascript:;" autocomplete="off">立即备份</a>
            <a id="optimize" class="btn bg-teal" href="<?php echo url('optimize'); ?>">优化表</a>
            <a id="repair" class="btn bg-yellow" href="<?php echo url('repair'); ?>">修复表</a>
        </div>
                    ...
                    <tbody>
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td class="action">
                                    <a class="ajax-get no-refresh btn btn-xs bg-teal" href="<?php echo url('optimize?tables='.$table['name']); ?>">优化表</a>&nbsp;
                                    <a class="ajax-get no-refresh btn btn-xs bg-yellow" href="<?php echo url('repair?tables='.$table['name']); ?>">修复表</a>
                                </td>
                            </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
...
<script src="__PUBLIC__/admin/js/common.js"></script>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo url("index",["type"=>$type]); ?>');
    (function($){
