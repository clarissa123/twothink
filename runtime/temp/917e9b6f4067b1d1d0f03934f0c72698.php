<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"F:\guishan\xiangmu\TwoThink\public/../application/user/view/default/login\register.html";i:1511097513;s:84:"F:\guishan\xiangmu\TwoThink\public/../application/user/view/default/public\base.html";i:1511097513;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<?php
	...
	$is_iframe = '';
	if($tpl_param['is_iframe'] == 1 || $tpl_param['is_popup']){
		$is_iframe = 1;
	}
if(!(empty($is_iframe) || (($is_iframe instanceof \think\Collection || $is_iframe instanceof \think\Paginator ) && $is_iframe->isEmpty()))): else: ?>
	<!-- 头部 -->
			...
			<div class="container">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li><a href="<?php echo url('user/login/register'); ?>">注册</a></li>
						<?php endif; ?>
					</ul>
				</div>
				<!-- /.navbar-custom-menu -->
