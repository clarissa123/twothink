...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="dd" id="nestable2">
            <ol class="dd-list">
                <?php echo action('Menu/tree', array($tree)); ?>
            </ol>
        </div>
    </div>
</div>
