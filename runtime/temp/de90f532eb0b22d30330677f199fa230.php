                ...
                <tbody>
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td>-</td>
                            <td class="action">
                                <a class="db-import btn btn-xs bg-teal" href="<?php echo url('import?time='.$data['time']); ?>">还原</a>&nbsp;
                                <a class="ajax-get confirm btn btn-xs bg-red" href="<?php echo url('del?time='.$data['time']); ?>">删除</a>
                            </td>
                        </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
