<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\guishan\xiangmu\TwoThink\public/../application/admin\view\repair\index.html";i:1521711590;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
//            ,height: 'full-335'
        ...
        //导航高亮
        var gl_id = $('.side-sub-menu').find('a[href="/admin/article/index.html"]').html();
        if((gl_id == "" || gl_id == undefined || gl_id == null)){
            highlight_subnav('/admin/article/index.html');
        }else {
            highlight_subnav('/admin/article/index.html');
        }
    });
