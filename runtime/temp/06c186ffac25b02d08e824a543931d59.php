<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/base\list.html";i:1521700547;s:85:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\base.html";i:1511097513;s:89:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\sidemenu.html";i:1511097513;s:88:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\sidebar.html";i:1511097513;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="btn-group seach-main col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="layui-input-inline value-html">
                        ...
                        <select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
                            <?php $_5ab34edf9a6f8=parse_field_attr($vo['extra']); if(is_array($_5ab34edf9a6f8) || $_5ab34edf9a6f8 instanceof \think\Collection || $_5ab34edf9a6f8 instanceof \think\Paginator): if( count($_5ab34edf9a6f8)==0 ) : echo "" ;else: foreach($_5ab34edf9a6f8 as $k=>$vos): ?>
...
<div class="extra_list" style="display: none;">
    ...
    <div class="<?php echo $vo['name']; ?>_extra_html">
        <?php switch($vo['type']): case "select": ?>
        <select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
            <?php $_5ab34edf9a546=parse_field_attr($vo['extra']); if(is_array($_5ab34edf9a546) || $_5ab34edf9a546 instanceof \think\Collection || $_5ab34edf9a546 instanceof \think\Paginator): if( count($_5ab34edf9a546)==0 ) : echo "" ;else: foreach($_5ab34edf9a546 as $k=>$vos): ?>
            <option value="<?php echo $k; ?>" <?php if($k == $vo['value']): ?> selected="selected" <?php endif; ?>><?php echo $vos; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php break; case "date": ?>date<?php break; case "datetime": ?>date<?php break; default: ?><input name="seach_all[value][]" class="layui-input" type="text" value="<?php echo $vo['value']; ?>">
