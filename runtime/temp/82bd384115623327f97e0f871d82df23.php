<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/addons\index.html";i:1511097513;s:85:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\base.html";i:1511097513;s:89:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\sidemenu.html";i:1511097513;s:88:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\sidebar.html";i:1511097513;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row">
	<div class="col-xs-12">
		<div>
			<div href="<?php echo url('create'); ?>" class="ajax-get iframe btn btn-sm bg-green"><i class="fa fa-fw fa-plus"></i>快速创建</div>
		</div>
		<!-- 数据列表 -->
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-success"><a target="_blank" href="<?php echo (isset($vo['url']) && ($vo['url'] !== '')?$vo['url']:'http://www.twothink.cn'); ?>"><?php echo $vo['author']; ?></a></td>
						<td><?php echo $vo['version']; ?></td>
						<td>
							<?php if(empty($vo['uninstall']) || (($vo['uninstall'] instanceof \think\Collection || $vo['uninstall'] instanceof \think\Paginator ) && $vo['uninstall']->isEmpty())): 									$class	= get_addon_class($vo['name']);
								...
								if ($has_config): ?>
									<a href="<?php echo url('config',array('id'=>$vo['id'])); ?>" class="ajax-get iframe  btn btn-xs btn-default" title="设置"><i class="fa fa-fw fa-cog"></i></a>
								<?php endif; if ($vo['status'] >=0): if($vo['status'] == '0'): ?>
									<a class="ajax-get btn btn-xs bg-green" href="<?php echo url('enable',array('id'=>$vo['id'])); ?>" title="启用"><i class="fa fa-fw fa-unlock"></i> </a>
								<?php else: ?>
									<a class="ajax-get btn btn-xs bg-yellow" href="<?php echo url('disable',array('id'=>$vo['id'])); ?>" title="禁用"><i class="fa fa-fw fa-lock"></i> </a>
								<?php endif; endif ?>
								
									<a class="ajax-get btn btn-xs btn-danger" href="<?php echo url('uninstall?id='.$vo['id']); ?>" title="卸载"><i class="fa fa-fw fa-trash-o"></i> </a>
								
							<?php else: ?>
								<a class="ajax-get btn btn-xs bg-gray-active" href="<?php echo url('install?addon_name='.$vo['name']); ?>" title="安装"><i class="fa fa-fw fa-shekel"></i> </a>
							<?php endif; ?>
						</td>
					</tr>
