<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/base\add.html";i:1511097513;s:83:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/base\edit.html";i:1511097513;s:85:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\base.html";i:1511097513;s:89:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\sidemenu.html";i:1511097513;s:84:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/base\input.html";i:1511097513;s:88:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/public\sidebar.html";i:1511097513;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <?php if(is_array($model_info['fields'][$key]) || $model_info['fields'][$key] instanceof \think\Collection || $model_info['fields'][$key] instanceof \think\Paginator): $i = 0; $__LIST__ = $model_info['fields'][$key];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i;if(!isset($field['is_show']) || $field['is_show'] == 1 || $field['is_show'] == 2): ?>
            ...
            <div class="form-group">
                ...
                <div class="controls layui-form">
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; break; case "checkbox":                         if(is_array($data[$field['name']])){
