<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/menu\sidenodes.html";i:1511097513;s:86:"F:\guishan\xiangmu\TwoThink\public/../application/admin/view/default/channel\tree.html";i:1511097513;}*/ ?>
...
<li class="dd-item dd-item-alt" data-id="<?php echo $list['id']; ?>">
    ...
    <div class="dd-content">
        <span class="pull-right">
            ...
            <a class="ajax-get btn btn-xs bg-yellow" title="<?php echo show_status_op($list['status']); ?>" href="<?php echo url('setStatus?ids='.$list['id'].'&status='.abs(1-$list['status'])); ?>"><?php echo show_status_op($list['status']); ?></a>
            <a class="confirm ajax-get btn btn-xs btn-danger" title="删除" href="<?php echo url('del?id='.$list['id']); ?>" class="confirm ajax-get">删除</a>
        </span>
    ...
    <ol class="dd-list">
        <?php echo action('Channel/tree', array($list['_'])); ?>
    </ol>
    <?php endif; ?>
</li>
