...
<?php if(empty($custom_adminlist) || (($custom_adminlist instanceof \think\Collection || $custom_adminlist instanceof \think\Paginator ) && $custom_adminlist->isEmpty())): ?>
				...
				<div class="btn-group seach-main col-md-6 col-sm-6 col-xs-12">
					...
					<div class="layui-input-inline value-html">
						...
						<select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
							<?php $_5ab3514dd180b=parse_field_attr($vo['extra']); if(is_array($_5ab3514dd180b) || $_5ab3514dd180b instanceof \think\Collection || $_5ab3514dd180b instanceof \think\Paginator): if( count($_5ab3514dd180b)==0 ) : echo "" ;else: foreach($_5ab3514dd180b as $k=>$vos): ?>
...
<div class="extra_list" style="display: none;">
	...
	<div class="<?php echo $vo['name']; ?>_extra_html">
		<?php switch($vo['type']): case "select": ?>
		<select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
			<?php $_5ab3514dd16ea=parse_field_attr($vo['extra']); if(is_array($_5ab3514dd16ea) || $_5ab3514dd16ea instanceof \think\Collection || $_5ab3514dd16ea instanceof \think\Paginator): if( count($_5ab3514dd16ea)==0 ) : echo "" ;else: foreach($_5ab3514dd16ea as $k=>$vos): ?>
			<option value="<?php echo $k; ?>" <?php if($k == $vo['value']): ?> selected="selected" <?php endif; ?>><?php echo $vos; ?></option>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</select>
		<?php break; case "date": ?>date<?php break; case "datetime": ?>date<?php break; default: ?><input name="seach_all[value][]" class="layui-input" type="text" value="<?php echo $vo['value']; ?>">
...
<?php else: if(isset($custom_adminlist)): ?>
		<?php echo $custom_adminlist; endif; endif; ?>
