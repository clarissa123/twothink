<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"F:\guishan\xiangmu\TwoThink\public/../application/home/view/default/index\index.html";i:1521785363;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <!-- Bootstrap -->
    <link href="__PUBLIC__/qiantai/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="__PUBLIC__/qiantai/css/style.css" rel="stylesheet">

    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
    <script src="__PUBLIC__/qiantai/cdn.bootcss.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="__PUBLIC__/qiantai//cdn.bootcss.com/respond.js/1.4.2/respond.min.js"></script>
    <![endif]-->
    <style>
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="__PUBLIC__/qiantai/image/index.png" width="100%" />
        </div>
...
<script src="__PUBLIC__/qiantai/jquery-1.11.2.min.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="__PUBLIC__/qiantai/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>